  ...
  render() {
    ...
    return (     
        <div class="card">
                ...
                <p style={{fontWeight: 'bold'}} >Post: <p class="card-title">{post.socialPost.postMessage}</p></p>
                <p style={{fontWeight: 'bold'}} >Suggested meet up Location: <p class="card-title">{post.socialPost.location}</p></p>
